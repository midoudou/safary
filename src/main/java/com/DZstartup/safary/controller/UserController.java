...
import com.DZstartup.safary.annotation.CurrentUser;
import com.DZstartup.safary.event.OnUserAccountChangeEvent;
import com.DZstartup.safary.event.OnUserLogoutSuccessEvent;
...
public class UserController {
    ...
    @GetMapping(value="/oauth2success")
    public ResponseEntity getMethodName() {
        return ResponseEntity.ok("dazazaz");
    }
