 ...
 */
package com.DZstartup.safary.controller;

import com.DZstartup.safary.event.OnGenerateResetLinkEvent;
import com.DZstartup.safary.event.OnRegenerateEmailVerificationEvent;
import com.DZstartup.safary.event.OnUserAccountChangeEvent;
import com.DZstartup.safary.event.OnUserRegistrationCompleteEvent;
import com.DZstartup.safary.exception.InvalidTokenRequestException;
import com.DZstartup.safary.exception.PasswordResetException;
import com.DZstartup.safary.exception.PasswordResetLinkException;
import com.DZstartup.safary.exception.TokenRefreshException;
import com.DZstartup.safary.exception.UserLoginException;
import com.DZstartup.safary.exception.UserRegistrationException;
import com.DZstartup.safary.model.CustomUserDetails;
import com.DZstartup.safary.model.payload.ApiResponse;
import com.DZstartup.safary.model.payload.JwtAuthenticationResponse;
import com.DZstartup.safary.model.payload.LoginRequest;
import com.DZstartup.safary.model.payload.PasswordResetLinkRequest;
import com.DZstartup.safary.model.payload.PasswordResetRequest;
import com.DZstartup.safary.model.payload.RegistrationRequest;
import com.DZstartup.safary.model.payload.TokenRefreshRequest;
import com.DZstartup.safary.model.token.EmailVerificationToken;
import com.DZstartup.safary.model.token.RefreshToken;
import com.DZstartup.safary.security.JwtTokenProvider;
import com.DZstartup.safary.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<String> getMethodName() {
        return ResponseEntity.ok("dadzazadjkzaj");
    }
